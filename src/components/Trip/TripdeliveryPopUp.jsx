...
import { callAPIgetListFoodActive, callAPIgetShipperOfKitchen, callAPIGetSlot, callAPIGetStationByKitchen } from "../../redux/action/acction";
import { URL_API } from "../../Axios/URL_API/URL";
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                CustomizedToast({
                    message: `Đã tạo chuyến ${valueTag} thành công`,
                    type: "SUCCESS",
                });
            } catch (error) {
                CustomizedToast({
